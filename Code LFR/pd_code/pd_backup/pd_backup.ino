...
int rightMaxSpeed=130;
int leftMaxSpeed=130;
...
void sharpturn() {
  ...
  if(digitalRead(8)==0 && digitalRead(7)==0 && digitalRead(6)==0 && digitalRead(5)==1 && digitalRead(4)==0 && digitalRead( 3)==0 && digitalRead(2)==0)
  {
    analogWrite(leftMotorPWM, 150);
    analogWrite(rightMotorPWM, 150);
    digitalWrite(rightMotor1, HIGH);
  ...
  else if(digitalRead(8)==0 && digitalRead(7)==0 && digitalRead(6)==0 && digitalRead(5)==1 && digitalRead(4)==1 && digitalRead( 3)==0 && digitalRead(2)==0)
  {
    analogWrite(leftMotorPWM, 150);
    analogWrite(rightMotorPWM, 190);
    digitalWrite(rightMotor1, HIGH);
    digitalWrite(leftMotor1,HIGH);
    delay(100);
  }
  else if(digitalRead(8)==0 && digitalRead(7)==0 && digitalRead(6)==0 && digitalRead(5)==1 && digitalRead(4)==1 && digitalRead( 3)==1 && digitalRead(2)==0)
  {
    analogWrite(leftMotorPWM, 150);
    analogWrite(rightMotorPWM, 190);
    digitalWrite(rightMotor1, HIGH);
  ...
  else if(digitalRead(8)==0 && digitalRead(7)==0 && digitalRead(6)==1 && digitalRead(5)==1 && digitalRead(4)==0 && digitalRead( 3)==0 && digitalRead(2)==0)
  {
    analogWrite(leftMotorPWM, 190);
    analogWrite(rightMotorPWM, 150);
    digitalWrite(rightMotor1, HIGH);
    digitalWrite(leftMotor1,HIGH);
    delay(100);
  }
  else if(digitalRead(8)==0 && digitalRead(7)==1 && digitalRead(6)==1 && digitalRead(5)==1 && digitalRead(4)==0 && digitalRead( 3)==0 && digitalRead(2)==0)
  {
    analogWrite(leftMotorPWM, 190);
    analogWrite(rightMotorPWM, 150);
    digitalWrite(rightMotor1, HIGH);
...
{
  sensor();
  /*if(digitalRead(8)==1 && digitalRead(7)==0 && digitalRead(6)==0 && digitalRead(5)==0 && digitalRead(4)==0 && digitalRead(3)==0 && digitalRead(2)==0)
  {
    analogWrite(leftMotorPWM, 150);
     analogWrite(rightMotorPWM, 50);
     digitalWrite(leftMotor1,HIGH);  
  ...
  if(digitalRead(8)==1 && digitalRead(7)==1 && digitalRead(6)==0 && digitalRead(5)==1 && digitalRead(4)==0 && digitalRead(3)==0 && digitalRead(2)==0)
  {
    analogWrite(leftMotorPWM, 150);
     analogWrite(rightMotorPWM, 50);
     digitalWrite(leftMotor1,HIGH);  
